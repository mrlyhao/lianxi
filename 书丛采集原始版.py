...
def Page(Html):
    try:
        ...
        data9 = []
        for item in items:
            data0.append(item[0].strip())
            data1.append(item[1].strip())
            data2.append(item[2].strip())
            data3.append(item[3].strip())
            data4.append(item[4].strip())
            data5.append(item[5].strip())
            data6.append(item[6].strip())
            data7.append(item[7].strip())
            data8.append(item[8].strip())
            data9.append(item[9].strip())
        data = {
            'ID':'',
            '书号':'',
            '标题':'',
